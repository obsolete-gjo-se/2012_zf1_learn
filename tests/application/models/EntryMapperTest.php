...
class Application_Model_EntryMapperTest extends PHPUnit_Framework_TestCase {
    ...
    public function setup(){
        ...
        $this->_mapper = new Application_Model_EntryMapper($this->_tableGateway);
    }
    ...
    protected function _getCleanMock($className){
        ...
        $mocked = $this->getMock($className, $stubMethods, array(), 
                $className . '_EntryMapperTestMock_' . uniqid(), false);
        return $mocked;
    }
    ...
    public function testUpdatesExistingEntry(){
        ...
        // quoteInto() wird aufgerufen, um die Parameter des Adapters zu
        // maskieren
