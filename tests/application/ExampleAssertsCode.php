...
class Application_ExampleAssertsCode extends Zend_Test_PHPUnit_ControllerTestCase {
    ...
    public function testPHPUNitAsserts (){
        ...
        $this->assertGreaterThanOrEqual($expected, $actual);
            $this->assertAttributeGreaterThanOrEqual($expected, $actualAttributeName, $actualClassOrObject);
